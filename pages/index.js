...
export default function Home() {
  ...
  const T = {
    tr: {
      ...
      btn1: '1000 Soruyu Oku', pdfTr: '1000 Soruda INK — Türkçe PDF', pdfEn: 'Divine Order — İngilizce PDF',
    ...
    en: {
      ...
      btn1: 'Read 1000 Questions', pdfTr: '1000 Questions INK — Turkish PDF', pdfEn: 'Divine Order — English PDF',
