...
export default function Home() {
  ...
  const T = {
    ...
    en: {
      ...
      sub: '1000 questions and answers about the structure of the universe, the journey of the soul, and the meaning of existence — the complete INK system in plain language.',
